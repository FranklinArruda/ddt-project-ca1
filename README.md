# DDT Project CA1 - Smart Contract
...
(The first line represents the compiler version of this project, the line below represents the smart contract name that wraps up the whole code. The uint orderIdCounter represents the unique ID of the order that keeps tracks of it used in order food).
...
## See below these functions interacting with the (Remix IDE) Interface:

![deployed_contract_image](https://github.com/FranklinArruda/ddt-project-ca1/assets/102427836/822bf50b-2476-4a29-82cc-dcba3412b5d4)

## Video DEMO:

https://github.com/FranklinArruda/ddt-project-ca1/assets/102427836/74e9915c-4361-4116-a21f-ff61b9c1f369
